...
def main():
    ...
    parser.add_argument("text", nargs="?", default=None, help="Text to analyse (optional)")
    parser.add_argument("--file",  type=str, help="Path to a .txt file to analyse (overrides positional text)")
